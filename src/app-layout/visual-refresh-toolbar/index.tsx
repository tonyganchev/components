  ...
  (props, forwardRef) => {
    ...
    return (
      <RemoteI18nProvider loadFormatter={loadFormatter}>
        <AppLayoutVisualRefreshToolbarWithI18n {...props} stateManagerRef={stateManagerRef} />
        <AppLayoutWidgetizedState forwardRef={forwardRef} appLayoutProps={props} stateManager={stateManagerRef} />
      </RemoteI18nProvider>
    );
  }
);
...
function AppLayoutVisualRefreshToolbarWithI18n({
  ...
  ariaLabels: ariaLabelsOverride,
  ...appLayoutProps
}: AppLayoutInternalProps & {
  stateManagerRef: React.MutableRefObject<StateManager>;
  __embeddedViewMode?: any;
  __forceDeduplicationType?: any;
}) {
  const ariaLabels = useAriaLabels(ariaLabelsOverride);
